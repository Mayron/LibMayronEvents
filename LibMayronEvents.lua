...
local Lib = _G.LibStub:NewLibrary("LibMayronEvents", 1.5);
...
local pairs, ipairs, tostring, unpack, table, select, strsplit, strtrim =
  _G.pairs, _G.ipairs, _G.tostring, _G.unpack, _G.table, _G.select, _G.strsplit, _G.strtrim;
